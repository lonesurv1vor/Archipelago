...
from BaseClasses import Entrance, LocationProgressType, Region
...
class CoQWorld(World):
    ...
    def set_rules(self):
        ...
        self.multiworld.completion_condition[self.player] = lambda state: victory_loc in state.locations_checked
